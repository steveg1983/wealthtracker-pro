...
export default {
  invariant: 'TS-I9',
  title: 'a * sent to MS Money is not a number on Money\'s scale',
  ...
  expect: { outcome: 'ok' },
  // Neither flag: a value off the scale is not a mark, and a row that was never
  // marked cannot have been committed.
