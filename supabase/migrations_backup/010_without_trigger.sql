-- Create budgets, goals, and investments tables WITHOUT the problematic trigger
-- We'll handle budget spent calculations in the application layer instead
...
-- Note: Budget spent amounts will be calculated in the application layer
-- This avoids the trigger complexity with the transactions table