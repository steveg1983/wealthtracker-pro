...
-- Add a partial unique index to ensure only one default layout per user
CREATE UNIQUE INDEX IF NOT EXISTS idx_dashboard_layouts_one_default_per_user 
...
-- Success
SELECT 'Dashboard layouts created successfully!' as status;