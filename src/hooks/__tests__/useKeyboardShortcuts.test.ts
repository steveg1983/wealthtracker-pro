...
describe('useKeyboardShortcuts', () => {
  ...
  describe('initialization', () => {
    ...
    it('loads data on mount when autoLoad is true', async () => {
      const { result } = renderHook(() => useKeyboardShortcuts({ autoLoad: true }), {
        wrapper: AllProviders
      });
  ...
  describe('actions', () => {
    ...
    it('handles errors gracefully', async () => {
      ...
      const { result } = renderHook(() => useKeyboardShortcuts({ fetcher: mockFetch }), {
        wrapper: AllProviders
      });
  ...
  describe('memoization', () => {
    it('memoizes expensive calculations', () => {
      ...
      const { result, rerender } = renderHook(
        ({ value }) => useKeyboardShortcuts({ value, calculate: expensiveCalculation }),
        {
          wrapper: AllProviders,
