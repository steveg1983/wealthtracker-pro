      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-4">
        <div className="flex items-start gap-3">
          <div className="flex-shrink-0">
            <RefreshCwIcon 
              size={24} 
              className={`text-gray-500 dark:text-gray-400 ${isUpdating ? 'animate-spin' : ''}`}
            />
          </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                disabled={isUpdating}
                /* Disabled is the house's opacity, not a second fill colour: the
                   button that cannot be pressed is the same button, dimmed
                   (stock-blue ruling, 28 Aug 2026). */
                className="px-4 py-2 text-sm font-medium text-white bg-[#1a2332] hover:bg-[#2d3a4d] disabled:opacity-50 rounded-lg transition-colors duration-200"
              >
