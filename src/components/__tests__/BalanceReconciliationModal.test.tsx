...
describe('BalanceReconciliationModal', () => {
  ...
  describe('rendering', () => {
    it('renders correctly with default props', () => {
      renderWithProviders(<BalanceReconciliationModal />);
      
      // Add specific assertions based on component
      expect(screen.getByTestId('balancereconciliationmodal')).toBeInTheDocument();
    });

    it('renders loading state when data is loading', () => {
      renderWithProviders(<BalanceReconciliationModal isLoading={true} />);
      
      expect(screen.getByTestId('loading-spinner')).toBeInTheDocument();
    });

    it('renders error state when error occurs', () => {
      renderWithProviders(<BalanceReconciliationModal error="Test error" />);
      
      expect(screen.getByText('Test error')).toBeInTheDocument();
    });

    it('renders empty state when no data', () => {
      renderWithProviders(<BalanceReconciliationModal data={[]} />);
  ...
  describe('user interactions', () => {
    it('handles click events correctly', async () => {
      ...
      renderWithProviders(<BalanceReconciliationModal onClick={mockOnClick} />);
    ...
    it('handles form submission', async () => {
      ...
      renderWithProviders(<BalanceReconciliationModal onSubmit={mockOnSubmit} />);
  ...
  describe('edge cases', () => {
    it('handles large datasets efficiently', () => {
      ...
      renderWithProviders(<BalanceReconciliationModal data={largeData} />);
    ...
    it('handles network errors gracefully', async () => {
      ...
      renderWithProviders(<BalanceReconciliationModal onFetch={mockFetch} />);
    ...
    it('prevents double submission', async () => {
      ...
      renderWithProviders(<BalanceReconciliationModal onSubmit={mockSubmit} />);
