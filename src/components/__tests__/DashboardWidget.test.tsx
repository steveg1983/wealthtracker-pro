...
describe('DashboardWidget', () => {
  ...
  describe('rendering', () => {
    it('renders correctly with default props', () => {
      ...
      expect(screen.getByTestId('dashboardwidget')).toBeInTheDocument();
    });

    it('renders loading state when data is loading', () => {
      renderWithProviders(<DashboardWidget isLoading={true} />);
      
      expect(screen.getByTestId('loading-spinner')).toBeInTheDocument();
    });

    it('renders error state when error occurs', () => {
      renderWithProviders(<DashboardWidget error="Test error" />);
      
      expect(screen.getByText('Test error')).toBeInTheDocument();
    });

    it('renders empty state when no data', () => {
      renderWithProviders(<DashboardWidget data={[]} />);
  ...
  describe('user interactions', () => {
    it('handles click events correctly', async () => {
      ...
      renderWithProviders(<DashboardWidget onClick={mockOnClick} />);
    ...
    it('handles form submission', async () => {
      ...
      renderWithProviders(<DashboardWidget onSubmit={mockOnSubmit} />);
  ...
  describe('edge cases', () => {
    it('handles large datasets efficiently', () => {
      ...
      renderWithProviders(<DashboardWidget data={largeData} />);
    ...
    it('handles network errors gracefully', async () => {
      ...
      renderWithProviders(<DashboardWidget onFetch={mockFetch} />);
    ...
    it('prevents double submission', async () => {
      ...
      renderWithProviders(<DashboardWidget onSubmit={mockSubmit} />);
