...
describe('GlobalSearch', () => {
  ...
  describe('rendering', () => {
    ...
    it('renders loading state when data is loading', () => {
      renderWithProviders(<GlobalSearch isLoading={true} />);
      
      expect(screen.getByTestId('loading-spinner')).toBeInTheDocument();
    });

    it('renders error state when error occurs', () => {
      renderWithProviders(<GlobalSearch error="Test error" />);
      
      expect(screen.getByText('Test error')).toBeInTheDocument();
    });

    it('renders empty state when no data', () => {
      renderWithProviders(<GlobalSearch data={[]} />);
  ...
  describe('user interactions', () => {
    it('handles click events correctly', async () => {
      ...
      renderWithProviders(<GlobalSearch onClick={mockOnClick} />);
    ...
    it('handles form submission', async () => {
      ...
      renderWithProviders(<GlobalSearch onSubmit={mockOnSubmit} />);
  ...
  describe('edge cases', () => {
    it('handles large datasets efficiently', () => {
      ...
      renderWithProviders(<GlobalSearch data={largeData} />);
    ...
    it('handles network errors gracefully', async () => {
      ...
      renderWithProviders(<GlobalSearch onFetch={mockFetch} />);
    ...
    it('prevents double submission', async () => {
      ...
      renderWithProviders(<GlobalSearch onSubmit={mockSubmit} />);
