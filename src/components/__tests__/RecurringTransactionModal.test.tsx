...
describe('RecurringTransactionModal', () => {
  ...
  describe('rendering', () => {
    it('renders correctly with default props', () => {
      renderWithProviders(<RecurringTransactionModal />);
      
      // Add specific assertions based on component
      expect(screen.getByTestId('recurringtransactionmodal')).toBeInTheDocument();
    });

    it('renders loading state when data is loading', () => {
      renderWithProviders(<RecurringTransactionModal isLoading={true} />);
      
      expect(screen.getByTestId('loading-spinner')).toBeInTheDocument();
    });

    it('renders error state when error occurs', () => {
      renderWithProviders(<RecurringTransactionModal error="Test error" />);
      
      expect(screen.getByText('Test error')).toBeInTheDocument();
    });

    it('renders empty state when no data', () => {
      renderWithProviders(<RecurringTransactionModal data={[]} />);
  ...
  describe('user interactions', () => {
    it('handles click events correctly', async () => {
      ...
      renderWithProviders(<RecurringTransactionModal onClick={mockOnClick} />);
    ...
    it('handles form submission', async () => {
      ...
      renderWithProviders(<RecurringTransactionModal onSubmit={mockOnSubmit} />);
  ...
  describe('edge cases', () => {
    it('handles large datasets efficiently', () => {
      ...
      renderWithProviders(<RecurringTransactionModal data={largeData} />);
    ...
    it('handles network errors gracefully', async () => {
      ...
      renderWithProviders(<RecurringTransactionModal onFetch={mockFetch} />);
    ...
    it('prevents double submission', async () => {
      ...
      renderWithProviders(<RecurringTransactionModal onSubmit={mockSubmit} />);
