...
export default function BalanceAdjustmentModal({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end sm:items-center justify-center z-50">
      <div className="bg-card-bg-light dark:bg-card-bg-dark rounded-t-2xl sm:rounded-2xl shadow-xl w-full sm:max-w-lg max-h-[90vh] sm:max-h-[85vh] overflow-y-auto">
        <div className="sticky top-0 bg-card-bg-light dark:bg-card-bg-dark border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 py-3 sm:py-4">
