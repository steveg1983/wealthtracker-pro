...
export default function EnhancedPortfolioView({ 
  ...
  return (
    <div>
      ...
      <div className="p-6 bg-card-bg-light dark:bg-card-bg-dark m-6 rounded-lg shadow-md border-2 border-blue-200 dark:border-gray-700 overflow-y-auto" style={{ maxHeight: 'calc(90vh - 8rem)' }}>
