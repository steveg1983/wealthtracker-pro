  ...
  if (showSuccess) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
        <div className="bg-card-bg-light dark:bg-card-bg-dark rounded-2xl p-8 max-w-md mx-4 text-center">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="0.00"
                  className="flex-1 px-3 py-2 bg-card-bg-light dark:bg-card-bg-dark border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                />
                <button
                  onClick={autoMatch}
