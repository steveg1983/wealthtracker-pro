...
export const OfflineTransactionForm: React.FC<OfflineTransactionFormProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-[#d4dce8] dark:bg-gray-800 rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-[#d4dce8] dark:bg-gray-800 border-b dark:border-gray-700 p-4">
