  ...
  return (
    <div ref={dropdownRef} className={`relative ${className}`}>
      ...
      <button
        ...
        className="w-full px-4 py-3 bg-card-bg-light dark:bg-card-bg-dark border border-gray-300 dark:border-gray-600 rounded-lg hover:border-gray-400 dark:hover:border-gray-500 transition-colors text-left"
      >
        {selectedCategory ? (
          <div className="flex items-center gap-3">
            <div 
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute z-50 w-full mt-2 bg-card-bg-light dark:bg-card-bg-dark rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          {/* Search input */}
