...
export const MobileTransactionList: React.FC<MobileTransactionListProps> = ({
  ...
  return (
    <div className="mobile-transaction-list">
      <div className="px-4 py-3 bg-card-bg-light dark:bg-card-bg-dark sticky top-0 z-10 border-b">
          ...
          <div key={date}>
            ...
            {dayTransactions.map(transaction => (
              <div
                ...
                className="px-4 py-3 bg-card-bg-light dark:bg-card-bg-dark active:bg-gray-50 transition-colors"
              >
