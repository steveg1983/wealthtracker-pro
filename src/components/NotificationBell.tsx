...
export default function NotificationBell(): React.JSX.Element {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 bg-card-bg-light dark:bg-card-bg-dark rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 max-h-[32rem] flex flex-col">
          {/* Header */}
