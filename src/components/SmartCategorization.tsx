    ...
    return (
      <div className="flex items-center gap-2 py-1">
        ...
        {showAllSuggestions && suggestions.length > 1 && (
          <div className="absolute z-10 mt-8 bg-card-bg-light dark:bg-card-bg-dark rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-2 min-w-[200px]">
          ...
          return (
            <div
              ...
              className={`
                ...
                ${index === 0 
                  ? 'border-purple-300 dark:border-purple-700 bg-card-bg-light dark:bg-card-bg-dark' 
