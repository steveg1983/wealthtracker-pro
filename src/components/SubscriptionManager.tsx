      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-lg bg-card-bg-light dark:bg-card-bg-dark text-gray-900 dark:text-white text-sm"
