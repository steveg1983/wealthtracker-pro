...
export function SkeletonCard({ className = '' }: { className?: string }): React.JSX.Element {
  return (
    <div className={`bg-card-bg-light dark:bg-card-bg-dark rounded-lg shadow p-6 ${className}`}>
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      {Array.from({ length: items }).map((_, i) => (
        <div key={i} className="flex items-center space-x-4 p-4 bg-card-bg-light dark:bg-card-bg-dark rounded-lg">
