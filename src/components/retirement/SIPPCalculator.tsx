...
export default function SIPPCalculator() {
  ...
  const finalBalance = projection.length > 0 ? projection[projection.length - 1].balance : currentBalance;
  const totalTaxRelief = projection.length > 0 ? projection[projection.length - 1].cumulativeTaxRelief : 0;
