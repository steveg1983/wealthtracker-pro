        ...
        <>
          <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-6">
            ...
            >
              ...
              {showBreakdown ? <ChevronUpIcon size={14} /> : <ChevronDownIcon size={14} />}
            </button>
              ...
              {bestStates.map((state, idx) => (
                ...
                >
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-500">
                    {state.effectiveRate.toFixed(2)}% effective
                  </p>
                </div>
              ))}
            </div>
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {comparisonResults.map((result) => {
                          const currentStateTax = calculation.stateTax;
                          const difference = result.stateTax - currentStateTax;
                          const afterTax = result.totalIncome - result.stateTax;
