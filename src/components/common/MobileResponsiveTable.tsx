...
export function MobileResponsiveTable<T>({
  ...
  return (
    <div className={className}>
      ...
      {/* Desktop Table View */}
      <div className="hidden sm:block bg-card-bg-light dark:bg-card-bg-dark rounded-lg shadow-sm overflow-hidden">
                ...
                return (
                  <tr
                    ...
                    className={`
                      ...
                      ${index % 2 === 0 ? 'bg-card-bg-light dark:bg-card-bg-dark' : 'bg-gray-50 dark:bg-gray-900'}
                    `}
                  >
                    {columns.map(column => (
                      <td
        ...
        {data.map(item => {
          ...
          return (
            <div
              ...
              onClick={onRowClick ? () => onRowClick(item) : undefined}
              className={`
                bg-card-bg-light dark:bg-card-bg-dark rounded-lg shadow-sm p-4
