/**
 * Analytics Tests
 * Tests for the Analytics component
 */
...
describe('Analytics', () => {
  ...
  describe('rendering', () => {
    ...
    it('renders loading state when data is loading', () => {
      renderWithProviders(<Analytics isLoading={true} />);
      
      expect(screen.getByTestId('loading-spinner')).toBeInTheDocument();
    });

    it('renders error state when error occurs', () => {
      renderWithProviders(<Analytics error="Test error" />);
      
      expect(screen.getByText('Test error')).toBeInTheDocument();
    });

    it('renders empty state when no data', () => {
      renderWithProviders(<Analytics data={[]} />);
  ...
  describe('user interactions', () => {
    it('handles click events correctly', async () => {
      ...
      renderWithProviders(<Analytics onClick={mockOnClick} />);
    ...
    it('handles form submission', async () => {
      ...
      renderWithProviders(<Analytics onSubmit={mockOnSubmit} />);
  ...
  describe('edge cases', () => {
    it('handles large datasets efficiently', () => {
      ...
      renderWithProviders(<Analytics data={largeData} />);
    ...
    it('handles network errors gracefully', async () => {
      ...
      renderWithProviders(<Analytics onFetch={mockFetch} />);
    ...
    it('prevents double submission', async () => {
      ...
      renderWithProviders(<Analytics onSubmit={mockSubmit} />);
