            ...
            {schedules.length === 0 ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {schedules.map((schedule) => (
                  <div
                    key={schedule.id}
                    className={`bg-card-bg-light dark:bg-card-bg-dark rounded-lg shadow-sm p-6 border-2 ${
                      schedule.isActive
        ...
        {activeTab === 'presets' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {presets.map((preset) => (
                <div key={preset.id} className="bg-card-bg-light dark:bg-card-bg-dark rounded-lg shadow-sm p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
