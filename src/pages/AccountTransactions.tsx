    ...
    <div className="flex flex-col h-full -m-4 md:-m-6 lg:-m-8 p-4 md:p-6 lg:p-8">
      ...
      <div className="relative mb-6">
        ...
        <div className="absolute right-4 top-1/2 -translate-y-1/2 grid grid-cols-2 gap-2">
          ...
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-xl shadow-lg border border-white/20 dark:border-gray-700/50 px-3 py-2 flex items-center justify-between min-w-[140px]">
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 p-4 mt-4">
