...
export default function EnhancedInvestments() {
      ...
      {rebalancingSuggestions.length === 0 ? (
        ...
        <div className="space-y-4">
          {rebalancingSuggestions.map((suggestion, index) => (
            <div key={index} className="bg-card-bg-light dark:bg-card-bg-dark rounded-lg p-4 shadow-sm">
  ...
  const _renderDividends = () => (
    <div className="space-y-6">
      ...
      {dividendInfo.length === 0 ? (
        ...
        <>
          <div className="bg-card-bg-light dark:bg-card-bg-dark rounded-lg p-4 mb-6">
          ...
          <div className="space-y-3">
            {dividendInfo.map((dividend, index) => (
              <div key={index} className="bg-card-bg-light dark:bg-card-bg-dark rounded-lg p-4">
                <div className="flex items-start justify-between">
                  <div>
  ...
  const renderBenchmarks = () => (
    <div className="space-y-6">
      ...
      {benchmarkData && (
        <>
          <div className="bg-card-bg-light dark:bg-card-bg-dark rounded-lg p-6">
