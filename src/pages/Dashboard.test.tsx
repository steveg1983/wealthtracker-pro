...
describe('Dashboard', () => {
  ...
  describe('rendering', () => {
    ...
    it('renders error state when error occurs', () => {
      renderWithProviders(<Dashboard error="Test error" />);
  ...
  describe('user interactions', () => {
    it('handles click events correctly', async () => {
      ...
      renderWithProviders(<Dashboard onClick={mockOnClick} />);
    ...
    it('handles form submission', async () => {
      ...
      renderWithProviders(<Dashboard onSubmit={mockOnSubmit} />);
  ...
  describe('edge cases', () => {
    it('handles large datasets efficiently', () => {
      ...
      renderWithProviders(<Dashboard data={largeData} />);
    ...
    it('handles network errors gracefully', async () => {
      ...
      renderWithProviders(<Dashboard onFetch={mockFetch} />);
    ...
    it('prevents double submission', async () => {
      ...
      renderWithProviders(<Dashboard onSubmit={mockSubmit} />);
