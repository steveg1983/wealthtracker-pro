...
describe('GoalService - REAL Database Tests', () => {
  beforeEach(async () => {
  ...
  describe('createGoal - REAL', () => {
    it('should create a real goal in the database', async () => {
      ...
      if (result.id) {
        ...
        expect(parseFloat(verifyData?.target_amount)).toBe(10000);
        expect(parseFloat(verifyData?.current_amount)).toBe(2500);
      }
    });
  ...
  describe('updateGoal - REAL', () => {
    it('should update a real goal in the database', async () => {
      ...
      expect(parseFloat(verifyData?.target_amount)).toBe(7500);
      expect(parseFloat(verifyData?.current_amount)).toBe(2000);
    });
  ...
  describe('contributeToGoal - REAL', () => {
    it('should add contribution to goal', async () => {
      ...
      expect(parseFloat(verifyData?.current_amount)).toBe(1500);
    });
