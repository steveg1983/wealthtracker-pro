...
import type { PageToggle } from '../../services/appSettingsService';
...
const PageVisibilitySection = memo(function PageVisibilitySection({ pageToggles
 }: PageVisibilitySectionProps): React.JSX.Element {
  const logger = useLogger();
  // Component initialization logging
  useEffect(() => {
    logger.info('PageVisibilitySection component initialized', {
      componentName: 'PageVisibilitySection'
    });
  }, []);
