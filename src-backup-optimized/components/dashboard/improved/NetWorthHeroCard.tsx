...
import { ArrowUpIcon, ArrowDownIcon, BanknoteIcon } from '../../icons';
 ...
 * Primary focus card showing overall financial position
 */
export const NetWorthHeroCard = memo(function NetWorthHeroCard({ netWorth,
  netWorthChange,
  ...
  formatCurrency,
  t
 }: NetWorthHeroCardProps): React.JSX.Element {
  const logger = useLogger();
  // Component initialization logging
  useEffect(() => {
    logger.info('NetWorthHeroCard component initialized', {
      componentName: 'NetWorthHeroCard'
    });
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-gray-200/20 dark:border-gray-700/20">
        ...
        <div>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            {t('dashboard.liabilities', 'Liabilities')}
          </p>
