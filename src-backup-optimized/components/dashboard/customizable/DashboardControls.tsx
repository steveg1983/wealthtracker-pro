...
const DashboardControls = memo(function DashboardControls({ isDragMode,
  isRefreshing,
  onRefreshAll,
  onToggleDragMode,
  onShowSettings,
  onShowAddWidget
 }: DashboardControlsProps): React.JSX.Element {
  const logger = useLogger();
  // Component initialization logging
  useEffect(() => {
    logger.info('DashboardControls component initialized', {
      componentName: 'DashboardControls'
    });
  }, []);
