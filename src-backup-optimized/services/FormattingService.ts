...
export class FormattingService {
   ...
   */
  formatCurrencyWithSign(amount: number | string | InstanceType<typeof Decimal>): string {
    const value = this.toNumber(amount);
   ...
   */
  formatCurrencyCompact(amount: number | string | InstanceType<typeof Decimal>): string {
    const value = this.toNumber(amount);
   ...
   */
  formatNumber(
    value: number | string | InstanceType<typeof Decimal>,
   ...
   */
  private toNumber(value: number | string | InstanceType<typeof Decimal>): number {
