    ...
    if (savedLayouts) {
      ...
      const mergedLayouts = {
        lg: defaultLayouts.lg.map(defaultItem => {
          const savedItem = parsed.lg?.find((item: any) => item.i === defaultItem.i);
          return savedItem ? { ...savedItem, h: defaultItem.h } : defaultItem;
        }),
        md: defaultLayouts.md.map(defaultItem => {
          const savedItem = parsed.md?.find((item: any) => item.i === defaultItem.i);
          return savedItem ? { ...savedItem, h: defaultItem.h } : defaultItem;
        }),
        sm: defaultLayouts.sm.map(defaultItem => {
          const savedItem = parsed.sm?.find((item: any) => item.i === defaultItem.i);
          return savedItem ? { ...savedItem, h: defaultItem.h } : defaultItem;
        })
      };
