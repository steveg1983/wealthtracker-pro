...
interface SavedCalculation {
  ...
  usState?: string;
  calculationDetails?: any; // Stores full calculation including two-tier details
  helpToBuy?: {
    equityLoan: number;
    deposit: number;
    mortgage: number;
  ...
  const handleUKCalculate = () => {
    ...
    if (ukFormData.useHelpToBuy && ukFormData.firstTimeBuyer) {
      try {
        ...
        loanAmount = htbCalc.mortgage; // Mortgage amount after Help to Buy
        helpToBuyDetails = htbCalc;
      } catch (error) {
        // If Help to Buy eligibility fails, continue with normal calculation
    ...
    const newCalc: SavedCalculation = {
      ...
      loanType: ukFormData.useTwoTierRate 
        ...
        : ukFormData.mortgageType,
      // Store the calculation details for display
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setUkFormData({ ...ukFormData, region: e.target.value as any })}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setUkFormData({ ...ukFormData, mortgageType: e.target.value as any })}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                      >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => setUkFormData({ ...ukFormData, initialRatePeriod: Number(e.target.value) as any })}
                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                          >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setUsFormData({ ...usFormData, loanType: e.target.value as any })}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                      >
