...
export function useRealtimeSync(options: UseRealtimeSyncOptions = {}): UseRealtimeSyncReturn {
  ...
  useEffect(() => {
    ...
    (window as unknown as { __updateRealtimeActionTimestamp?: typeof updateLastActionTimestamp }).__updateRealtimeActionTimestamp = updateLastActionTimestamp;
    
    return () => {
      delete (window as unknown as { __updateRealtimeActionTimestamp?: typeof updateLastActionTimestamp }).__updateRealtimeActionTimestamp;
    };
