...
export function useHapticFeedback() {
  ...
  const triggerHaptic = useCallback(async (
    ...
    try {
      ...
      const navWithHaptic = window.navigator as NavigatorWithHaptic;
      if (navWithHaptic.hapticFeedback) {
        const hapticAPI = navWithHaptic.hapticFeedback;
...
export function HapticWrapper({
  ...
  const props: Record<string, (e: Event) => void> = {};
  ...
  switch (trigger) {
    ...
    case 'touchstart':
      props.onTouchStart = (e: Event) => {
        handleTrigger();
        (children.props as Record<string, unknown>).onTouchStart?.(e);
      };
      break;
  }
