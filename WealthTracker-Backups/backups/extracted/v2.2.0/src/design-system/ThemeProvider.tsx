...
interface ThemeContextValue {
  ...
  createCustomTheme: (name: string, baseThemeId: string, overrides: unknown) => void;
  customThemes: Theme[];
}
...
export function ThemeProvider({ 
  ...
  const createCustomTheme = useCallback((name: string, baseThemeId: string, overrides: unknown) => {
