...
const AccessibilityDashboard = lazyWithPreload(() => import(/* webpackChunkName: "accessibility-dashboard" */ './components/AccessibilityDashboard').then(m => ({ default: m.AccessibilityDashboard })));
