...
const createIconComponent = (TablerIcon: React.ComponentType<IconProps>, displayName: string) => {
...
export const IconBase = ({ children, ...props }: React.HTMLAttributes<HTMLDivElement>) => <div {...props}>{children}</div>;
