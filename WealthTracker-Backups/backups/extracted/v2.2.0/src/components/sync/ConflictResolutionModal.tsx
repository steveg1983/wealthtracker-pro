...
type ConflictValue = Account | Transaction | Budget | Category | Record<string, unknown>;
...
export default function ConflictResolutionModal({
  ...
  const renderValue = (value: ConflictValue, type: SyncConflict['type']): React.JSX.Element => {
    if (type === 'transaction') {
      return (
