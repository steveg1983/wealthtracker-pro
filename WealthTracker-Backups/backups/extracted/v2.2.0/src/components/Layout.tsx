...
const SidebarLink = memo(function SidebarLink({ to, icon: Icon, label, isCollapsed, hasSubItems, isSubItem, onNavigate }: SidebarLinkProps): React.JSX.Element {
...
const Layout = memo(function Layout(): React.JSX.Element {
