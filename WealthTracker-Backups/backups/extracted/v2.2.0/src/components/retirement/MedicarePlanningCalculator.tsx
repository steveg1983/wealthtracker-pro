              ...
              <>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setPlan(prev => ({
                      ...prev,
                      partB: { ...prev.partB, filingStatus: e.target.value as 'single' | 'married_joint' | 'married_separate' }
                    }))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
                  >
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => setPlan(prev => ({
                  ...prev,
                  supplemental: { ...prev.supplemental, type: e.target.value as 'none' | 'medigap' | 'advantage' }
                }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
              >
