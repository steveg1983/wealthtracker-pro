...
type HistoryEntry = { timestamp: number; success: boolean; format?: string; filesCreated?: number; error?: string };
type StoredBackup = { id: number; filename: string; format: string; timestamp: number; size: number; cloudSynced: boolean };
