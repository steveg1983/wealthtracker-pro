...
export default function BudgetRecommendations() {
  ...
  const handleApplyRecommendation = (recommendation: BudgetRecommendation) => {
    const existingBudget = budgets.find(b => (b.categoryId || b.category) === recommendation.categoryId);
  ...
  const handleApplySelected = () => {
    ...
    updates.forEach(({ categoryId, amount }) => {
      const existingBudget = budgets.find(b => (b.categoryId || b.category) === categoryId);
