...
type ContrastCheckResult = ReturnType<typeof ColorContrastChecker.checkContrast>;
...
export const AccessibilityDashboard: React.FC = () => {
  ...
  const [colorContrastResults, setColorContrastResults] = React.useState<Array<{ name: string; fg: string; bg: string; result: ContrastCheckResult }>>([]);
