...
interface AppContextType extends AppState {
  ...
  exportData: () => AppState;
  clearAllData: () => void;
  getDecimalTransactions: () => DecimalTransaction[]; // Returns DecimalTransaction[] for decimal calculations
  getDecimalAccounts: () => DecimalAccount[]; // Returns DecimalAccount[] for decimal calculations
  getDecimalGoals: () => DecimalGoal[]; // Returns DecimalGoal[] for decimal calculations
