...
export interface Budget {
  id: string;
  categoryId: string;  // Preferred id field
  category?: string;   // Backward-compat display/name field used by legacy code
  amount: number;
...
// Import and re-export specific types for better tree-shaking
// Widget types
export type { 
  WidgetSettings, 
  BaseWidgetProps 
...
// Aggregate application state shape used by AppContext
