...
// Type for flexible JSON data structures
type FinancialPlanData = Record<string, string | number | boolean | null | FinancialPlanData | FinancialPlanData[]>;

// Type for mortgage results
...
// Type for saved calculation inputs/results
type CalculationData = Record<string, string | number | boolean | null | CalculationData | CalculationData[]>;
...
export interface FinancialPlan {
  ...
  name: string;
  description?: string;
  data: FinancialPlanData; // JSONB data
  region: string;
  currency: string;
  is_active: boolean;
  is_favorite: boolean;
...
export interface MortgageCalculation {
  ...
  results: MortgageResults; // JSONB results
...
export type FinancialPlanCreate = Omit<FinancialPlan, 'id' | 'created_at' | 'updated_at'>;
...
export type SavedCalculationCreate = Omit<SavedCalculation, 'id' | 'created_at' | 'updated_at'>;
