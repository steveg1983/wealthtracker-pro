...
// Type definition from layoutSlice
  ...
  describe('edge cases', () => {
    it('handles boolean-like values correctly', () => {
      ...
      const testValues = [
        ...
        { value: 1 as unknown as boolean, expected: 1 as unknown },
        { value: 0 as unknown as boolean, expected: 0 as unknown },
        { value: '' as unknown as boolean, expected: '' as unknown },
        { value: 'true' as unknown as boolean, expected: 'true' as unknown },
      ];
