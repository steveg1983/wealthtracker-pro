...
// Type for log data - can be primitives, objects, arrays, or errors
...
class LoggingService {
   ...
   */
  private log(level: LogLevel, message: string, data?: LogData, source?: string): void {
   ...
   */
  private sendToErrorTracking(message: string, error?: Error | LogData, source?: string): void {
    try {
