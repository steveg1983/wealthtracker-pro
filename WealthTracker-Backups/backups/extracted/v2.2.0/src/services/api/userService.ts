...
export class UserService {
   ...
   */
  static async updatePreferences(clerkId: string, preferences: Record<string, unknown>): Promise<void> {
    if (!isSupabaseConfigured()) {
   ...
   */
  static async updateSettings(clerkId: string, settings: Record<string, unknown>): Promise<void> {
    if (!isSupabaseConfigured()) {
      // Fallback to localStorage
