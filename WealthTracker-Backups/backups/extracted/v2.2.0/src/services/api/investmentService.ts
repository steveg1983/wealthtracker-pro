...
class InvestmentService {
   ...
   */
  private mapInvestment(data: Record<string, unknown>): Investment {
    return {
      ...
      costBasis: parseFloat(String(data.cost_basis)),
      currentPrice: data.current_price ? parseFloat(String(data.current_price)) : undefined,
      marketValue: data.market_value ? parseFloat(String(data.market_value)) : undefined,
      assetType: data.asset_type as Investment['assetType'],
      exchange: data.exchange as string | undefined,
      currency: data.currency as string,
      purchaseDate: data.purchase_date ? new Date(String(data.purchase_date)) : undefined,
      purchasePrice: data.purchase_price ? parseFloat(String(data.purchase_price)) : undefined,
      lastUpdated: data.last_updated ? new Date(String(data.last_updated)) : undefined,
   ...
   */
  private mapTransaction(data: Record<string, unknown>): InvestmentTransaction {
    return {
      id: data.id,
