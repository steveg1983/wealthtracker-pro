    ...
    try {
      ...
      if (householdData) {
        ...
        this.household = {
          ...
          members: parsed.members.map((m: HouseholdMember) => ({
            ...m,
      ...
      if (invitesData) {
        this.invites = JSON.parse(invitesData).map((i: HouseholdInvite) => ({
          ...i,
      ...
      if (activitiesData) {
        this.activities = JSON.parse(activitiesData).map((a: MemberActivity) => ({
          ...a,
