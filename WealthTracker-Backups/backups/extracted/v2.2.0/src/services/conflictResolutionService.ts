...
// Replace lodash with modular imports for better tree-shaking
import isEqual from 'lodash/isEqual';
import differenceWith from 'lodash/differenceWith';
import intersectionWith from 'lodash/intersectionWith';

// Base type for all entity data
export type EntityValue = string | number | boolean | Date | null | undefined | EntityValue[] | { [key: string]: EntityValue };
...
export interface MergeRule {
  ...
  condition?: (clientValue: EntityValue, serverValue: EntityValue) => boolean;
}
...
export class ConflictResolutionService {
   ...
   */
  private static getChangedFields(obj1: EntityData, obj2: EntityData): string[] {
  ...
  private static isNonConflictingChange(
    field: string,
    clientValue: EntityValue,
    serverValue: EntityValue,
    entityType: string
  ): boolean {
