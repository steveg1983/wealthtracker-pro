...
export class RealTestDatabase {
  ...
  // ============ ACCOUNT OPERATIONS ============
  async createAccount(userId: string, data: Partial<any> = {}) {
    const accountData = {
      id: faker.string.uuid(),
      user_id: userId,
  ...
  async createTransaction(userId: string, accountId: string, data: Partial<any> = {}) {
  ...
  // ============ CATEGORY OPERATIONS ============
  async createCategory(userId: string, data: Partial<any> = {}) {
    const categoryData = {
      id: faker.string.uuid(),
      user_id: userId,
  ...
  // ============ BUDGET OPERATIONS ============
  async createBudget(userId: string, categoryId: string, data: Partial<any> = {}) {
    const budgetData = {
      id: faker.string.uuid(),
      user_id: userId,
  ...
  // ============ GOAL OPERATIONS ============
  async createGoal(userId: string, data: Partial<any> = {}) {
    const goalData = {
      id: faker.string.uuid(),
      user_id: userId,
  ...
  async createRecurringTransaction(userId: string, data: Partial<any> = {}) {
    const recurringData = {
      id: faker.string.uuid(),
      user_id: userId,
      description: faker.commerce.productName(),
  ...
  async createNotification(userId: string, data: Partial<any> = {}) {
