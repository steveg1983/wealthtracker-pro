...
import type { MouseEvent, FocusEvent, TouchEvent } from 'react';
...
export const HapticPattern = HAPTIC_PATTERN;
...
export function HapticWrapper({
  ...
  switch (trigger) {
    case 'click':
      props.onClick = (e: MouseEvent<unknown>) => {
        handleTrigger();
        children.props.onClick?.(e);
      };
      break;
    case 'focus':
      props.onFocus = (e: FocusEvent<unknown>) => {
        handleTrigger();
        children.props.onFocus?.(e);
      };
      break;
    case 'hover':
      props.onMouseEnter = (e: MouseEvent<unknown>) => {
        handleTrigger();
        children.props.onMouseEnter?.(e);
      };
      break;
    case 'touchstart':
      props.onTouchStart = (e: TouchEvent<unknown>) => {
        handleTrigger();
...
export function withHapticFeedback<P extends object>(
  ...
  defaultPattern: HapticPattern = HAPTIC_PATTERN.LIGHT
) {
