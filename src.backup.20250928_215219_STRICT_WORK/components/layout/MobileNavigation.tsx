      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 bottom-0 w-80 bg-white dark:bg-gray-800 shadow-xl z-50 sm:hidden overflow-y-auto"
          >
            {/* Header */}
...
export function useSwipeToOpenNav() {
  ...
  const onTouchEnd = () => {
    ...
    const isEdgeSwipe = touchStart < 20; // Started from left edge
