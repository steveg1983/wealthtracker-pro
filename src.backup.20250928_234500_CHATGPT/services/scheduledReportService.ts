...
class ScheduledReportService {
  ...
  // Export to PDF
  private async exportToPDF(reportData: any, customReport: CustomReport, data: any): Promise<Blob> {
  ...
  // Export to CSV
  private async exportToCSV(reportData: any, data: any): Promise<void> {
  ...
  // Export to Excel
  private async exportToExcel(reportData: any, data: any): Promise<void> {
