        ...
        if (typeof navigator !== 'undefined') {
          if ('share' in navigator && typeof navigator.share === 'function') {
            navigator.share({ text }).catch(() => {
              // Swallow share cancellation errors
            });
        ...
        <div className="p-4">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3 mb-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {transaction.amount.toLocaleString()} • {transaction.date.toLocaleDateString()}
            </p>
          </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-3 gap-3">
            ...
            <button className="flex flex-col items-center gap-1 py-3 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
              <StarIcon size={20} className="text-gray-600 dark:text-gray-400" />
