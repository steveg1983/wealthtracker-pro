        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-1">
            {getNavigationItems(t).map((item) => {
              const highlightOffset = hoveredDropdownIndex === null
                ? undefined
                : dropdownItemPositions[item.label]?.[hoveredDropdownIndex];
                ...
                {item.children && activeDropdown === item.label && (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        transform: typeof highlightOffset === 'number'
                          ? `translateY(${highlightOffset - 4}px) scale(1.02)`
                          : 'translateY(-40px) scale(0.95)',
                        opacity: typeof highlightOffset === 'number' ? 1 : 0,
