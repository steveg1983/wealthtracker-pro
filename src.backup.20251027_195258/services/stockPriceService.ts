import { getExchangeRates } from '../utils/currency-decimal';
  ...
  for (const endpoint of YAHOO_FINANCE_ENDPOINTS) {
    try {
      ...
      const stockQuote: StockQuote = {
        ...
        lastUpdated: new Date(),
        ...(meta.marketCap && { marketCap: toDecimal(meta.marketCap) }),
        ...(meta.regularMarketDayHigh && { dayHigh: toDecimal(meta.regularMarketDayHigh) }),
        ...(meta.regularMarketDayLow && { dayLow: toDecimal(meta.regularMarketDayLow) }),
        ...(meta.fiftyTwoWeekHigh && { fiftyTwoWeekHigh: toDecimal(meta.fiftyTwoWeekHigh) }),
        ...(meta.fiftyTwoWeekLow && { fiftyTwoWeekLow: toDecimal(meta.fiftyTwoWeekLow) })
      };
