...
describe('BudgetCalculationService', () => {
  ...
  describe('getCurrentPeriod', () => {
    ...
    it('should calculate fallback quarterly period as custom range', () => {
