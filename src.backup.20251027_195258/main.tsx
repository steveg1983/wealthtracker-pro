...
import { registerAnalyticsNetworkForwarder } from './services/analyticsBridge'
...
const logger = lazyLogger.getLogger('Main');

const ANALYTICS_ENDPOINT = import.meta.env.VITE_ANALYTICS_ENDPOINT as string | undefined;
const ANALYTICS_WITH_CREDENTIALS = import.meta.env.VITE_ANALYTICS_WITH_CREDENTIALS === 'true';

if (ANALYTICS_ENDPOINT) {
  registerAnalyticsNetworkForwarder({
    endpoint: ANALYTICS_ENDPOINT,
    includeCredentials: ANALYTICS_WITH_CREDENTIALS,
  });
}
...
serviceWorkerRegistration.register({
  onSuccess: async (registration) => {
    ...
    (window as Window & { swRegistration?: ServiceWorkerRegistration }).swRegistration = registration;
