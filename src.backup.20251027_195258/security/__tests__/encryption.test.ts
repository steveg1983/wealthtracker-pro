...
describe('Enhanced Encryption Service', () => {
  let enhancedEncryption: Awaited<ReturnType<typeof getEnhancedEncryption>>;
  ...
  describe('Encryption and Decryption', () => {
    ...
    it('fails to decrypt with tampered data', async () => {
      ...
      expect(() => enhancedEncryption.decrypt(tampered)).toThrow();
    });
  ...
  describe('Key Management', () => {
    ...
    it('clears sensitive data', async () => {
      ...
      enhancedEncryption.encrypt(testData);
