  ...
  useEffect(() => {
    const alerts = budgetsWithSpent
      ...
      .map(budget => {
        ...
        const percentageDecimal = toDecimal(budget.percentage);
        if (percentageDecimal.greaterThanOrEqualTo(100)) {
          return {
            budgetId: budget.id,
            categoryName: category?.name || 'Unknown',
            percentage: percentageDecimal.toDecimalPlaces(0).toNumber(),
            spent: budget.spent,
            budget: budget.amount,
            period: budget.period,
            type: 'danger' as const
          };
        } else if (percentageDecimal.greaterThanOrEqualTo(alertThreshold)) {
          return {
            budgetId: budget.id,
            categoryName: category?.name || 'Unknown',
            percentage: percentageDecimal.toDecimalPlaces(0).toNumber(),
  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-1 bg-gray-100 dark:bg-gray-700 p-1 rounded-lg mb-6">
        ...
        >
          <ProfessionalIcon name="banknote" size={16} />
          Traditional
        </button>
        <button
        ...
        >
          <ProfessionalIcon name="piggyBank" size={16} />
          Envelope
        </button>
        <button
        ...
        >
          <ProfessionalIcon name="repeat" size={16} />
          Templates
        </button>
        <button
        ...
        >
          <ProfessionalIcon name="arrowRight" size={16} />
          Rollover
        </button>
        <button
        ...
        >
          <ProfessionalIcon name="calculator" size={16} />
          Zero-Based
        </button>
      </div>
      ...
      {activeTab === 'traditional' && (
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 p-6">
          <div className="flex items-center justify-between">
            ...
            <ProfessionalIcon name="banknote" className="text-gray-400" size={24} />
          </div>
        </div>
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 p-6">
          <div className="flex items-center justify-between">
            ...
            <ProfessionalIcon name="trendingDown" className="text-red-500" size={24} />
          </div>
        </div>
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 p-6">
          <div className="flex items-center justify-between">
            ...
            <ProfessionalIcon name="trendingUp" className={totalRemainingValue >= 0 ? 'text-green-500' : 'text-red-500'} size={24} />
          </div>
        </div>
        </div>
            ...
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex gap-3">
                ...
                <IconButton
                  ...
                  icon={<ProfessionalIcon name="edit" size={20} />}
                  variant="ghost"
                  size="md"
                ...
                <IconButton
                  ...
                  icon={<ProfessionalIcon name="delete" size={20} />}
                  variant="ghost"
                  size="md"
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-gray-600 dark:text-gray-400">
                  {formatPercentageValue(budget.percentage, 0)} used
                </span>
