...
export default function CustomReports(): React.JSX.Element {
  ...
  const handleGenerateReport = async (report: CustomReport) => {
    ...
    try {
      await customReportService.generateReportData(report, {
        transactions,
        accounts,
        budgets,
        categories
  ...
  if (showBuilder || editingReport) {
    return (
      <CustomReportBuilder
        {...(editingReport ? { report: editingReport } : {})}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6">
        ...
        {reports.length === 0 ? (
          <div className="text-center py-12">
            <ProfessionalIcon name="reports" size={48} className="mx-auto text-gray-400 mb-4" />
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-2 text-xs text-gray-500 dark:text-gray-500">
                    <span className="flex items-center gap-1">
                      <ProfessionalIcon name="calendar" size={14} />
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {generatingReport === report.id ? (
                      ...
                      <ProfessionalIcon name="play" size={18} />
                    )}
                  </button>
                  ...
                  <button
                    ...
                    title="Edit"
                  >
                    <ProfessionalIcon name="edit" size={18} />
                  </button>
                  ...
                  <button
                    ...
                    title="Duplicate"
                  >
                    <ProfessionalIcon name="copy" size={18} />
                  </button>
                  ...
                  <button
                    ...
                    title="Delete"
                  >
                    <ProfessionalIcon name="delete" size={18} />
                  </button>
                </div>
              </div>
            ))}
