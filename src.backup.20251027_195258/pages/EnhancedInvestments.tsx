...
const formatDecimalValue = (value: DecimalInstance | number, decimals: number = 2): string => {
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {formatPercentageValue(riskMetrics.standardDeviation, 1)}
              </p>
              <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {formatPercentageValue(riskMetrics.diversificationScore, 0)}
              </p>
                ...
                {riskMetrics.concentrationRisk.map((risk, index) => (
                  <div key={index} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-700/50 rounded">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-gray-600 dark:text-gray-400">{formatPercentageValue(risk.percent, 1)}</span>
                      <span className={`px-2 py-1 rounded text-xs font-semibold ${
                        risk.risk === 'high' 
                          ? 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'
                          : risk.risk === 'medium'
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <p className={`text-2xl font-bold ${
                  ...
                  {formatSignedPercentageValue(benchmarkData.portfolio.return, 2)}
                </p>
              </div>
              <div>
                ...
                <p className={`text-2xl font-bold ${
                  ...
                  {formatSignedPercentageValue(benchmarkData.portfolio.annualizedReturn, 2)}
                </p>
              </div>
              <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-lg font-semibold text-gray-900 dark:text-white">
                      {formatPercentageValue(benchmark.annualizedReturn, 2)}
                    </p>
                    <p className={`text-sm font-medium ${
                      ...
                      {benchmark.outperformance >= 0 ? 'Outperforming' : 'Underperforming'} by {formatPercentageValue(toDecimal(benchmark.outperformance).abs(), 2)}
                    </p>
                  </div>
                </div>
              </div>
