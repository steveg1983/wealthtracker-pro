    ...
    return budgets
      ...
      .map((budget) => {
        ...
        const decimalBudget = {
          ...
          category: categories.find(c => c.id === budget.categoryId)?.name ?? budget.categoryId
        };
  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-1 bg-gray-100 dark:bg-gray-700 p-1 rounded-lg mb-6">
        ...
        >
          <ProfessionalIcon name="calendar" size={16} />
          Seasonal Trends
        </button>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <ProfessionalIcon
                      name="trendingUp"
                      className={totalRemainingValue >= 0 ? 'text-green-500' : 'text-red-500'}
                      size={24}
                    />
                  </div>
                </div>
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="flex items-center gap-1">
                          <IconButton
                            icon={<ProfessionalIcon name="edit" size={16} />}
                          ...
                          />
                          <IconButton
                            icon={<ProfessionalIcon name="delete" size={16} />}
      ...
      {activeTab === 'forecast' && (
        <CashFlowForecast 
          accountIds={selectedAccountIds.length > 0 ? selectedAccountIds : accounts.map(account => account.id)}
        />
      )}
            ...
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center">
                  <ProfessionalIcon name="trendingUp" className="text-primary" size={24} />
                </div>
              </div>
