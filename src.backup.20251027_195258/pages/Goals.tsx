...
export default function Goals() {
  const { goals, deleteGoal, getDecimalGoals, getDecimalAccounts } = useApp();
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span className="font-medium text-gray-900 dark:text-white">{formatPercentageValue(progress, 1)}</span>
                      </div>
