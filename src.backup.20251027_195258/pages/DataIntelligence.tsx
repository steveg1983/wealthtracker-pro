                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    ...
                    <div className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                      {stats.totalMerchants > 0 
                        ? `${stats.enrichedMerchants} enriched (${formatPercentageValue(stats.categoryAccuracy, 1)})`
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    ...
                    <div className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                      {detectedSubscriptions.length > 0 
                        ...
                        : stats.monthlySubscriptionCost.greaterThan(0) 
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div 
                          ...
                          style={{ width: `${stats.categoryAccuracy.toNumber()}%` }}
                        />
                      </div>
                      <span className="text-sm font-medium text-gray-900 dark:text-white">
                        {formatPercentageValue(stats.categoryAccuracy, 0)}
                      </span>
                    </div>
                  </div>
