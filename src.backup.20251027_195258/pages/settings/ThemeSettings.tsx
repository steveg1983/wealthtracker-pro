...
export default function ThemeSettings() {
  ...
  const headerIconName = getCurrentTheme() === 'dark' ? 'moon' : 'sun';
  const headerIcon = <ProfessionalIcon name={headerIconName} size={32} className="text-white" />;

  return (
    <PageWrapper
      title="Theme Settings"
      subtitle="Customize appearance and automate theme switching"
      icon={headerIcon}
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            <div className="flex items-center gap-3">
              {getCurrentTheme() === 'dark' ? (
                <ProfessionalIcon name="moon" size={20} className="text-gray-600 dark:text-gray-500" />
              ) : (
                <ProfessionalIcon name="sun" size={20} className="text-yellow-600 dark:text-yellow-400" />
              )}
              <div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            <div className="flex items-center gap-3">
              <ProfessionalIcon name="clock" size={20} className="text-green-600 dark:text-green-400" />
              <div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            <div className="flex items-center gap-3">
              <ProfessionalIcon name="refresh" size={20} className="text-purple-600 dark:text-purple-400" />
              <div>
            ...
            <nav className="flex space-x-8 overflow-x-auto">
              ...
              >
                <div className="flex items-center gap-2">
                  <ProfessionalIcon name="clock" size={16} />
              ...
              >
                <div className="flex items-center gap-2">
                  <ProfessionalIcon name="palette" size={16} />
          ...
          <div className="space-y-6">
            ...
            {schedules.length === 0 ? (
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 text-center">
                <ProfessionalIcon name="clock" size={48} className="mx-auto mb-4 text-gray-400" />
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {schedule.isActive ? <ProfessionalIcon name="stop" size={16} /> : <ProfessionalIcon name="play" size={16} />}
                        </button>
                        <button
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      {schedule.scheduleType === 'sunrise-sunset' && (
                        <div className="flex justify-between">
                          ...
                          <span className="text-gray-900 dark:text-white">
                            {typeof schedule.latitude === 'number' && typeof schedule.longitude === 'number'
                              ? `${formatDecimalFixed(schedule.latitude, 2)}, ${formatDecimalFixed(schedule.longitude, 2)}`
                              : 'Not set'
                            }
                          </span>
                        </div>
