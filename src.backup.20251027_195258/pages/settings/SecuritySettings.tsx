...
export default function SecuritySettings() {
  ...
  return (
    <PageWrapper
      ...
      subtitle="Protect your financial data with advanced security controls"
      icon={<ProfessionalIcon name="shield" size={32} className="text-white" />}
    >
      <div className="max-w-4xl mx-auto">
        ...
        {setupMessage && (
          <div className={`mb-6 p-4 rounded-lg flex items-center gap-3 ${
            ...
            {setupMessage.type === 'success' ? (
              <ProfessionalIcon name="success" size={20} />
            ) : (
              <ProfessionalIcon name="error" size={20} />
            )}
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                  <ProfessionalIcon name="phone" size={20} className="text-indigo-600 dark:text-indigo-400" />
                  Two-Factor Authentication
                </h3>
            ...
            {settings.twoFactorEnabled && (
              <div className="mt-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                <p className="text-sm text-green-800 dark:text-green-200 flex items-center gap-2">
                  <ProfessionalIcon name="success" size={16} />
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                  <ProfessionalIcon name="fingerprint" size={20} className="text-purple-600 dark:text-purple-400" />
                  Biometric Authentication
                </h3>
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                  <ProfessionalIcon name="lock" size={20} className="text-green-600 dark:text-green-400" />
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                  <ProfessionalIcon name="eye" size={20} className="text-gray-600 dark:text-gray-500" />
                  Read-Only Mode
                </h3>
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2 mb-4">
              <ProfessionalIcon name="refresh" size={20} className="text-orange-600 dark:text-orange-400" />
              Session Timeout
            </h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2 mb-4">
              <ProfessionalIcon name="document" size={20} className="text-gray-600 dark:text-gray-400" />
                ...
                <div>
                  ...
                  <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg text-center">
                    <div className="inline-block p-4 bg-white dark:bg-gray-800 rounded">
                      <ProfessionalIcon name="key" size={48} className="text-gray-400" />
