        ...
        <div className="flex items-center gap-2 flex-1">
          {isEditMode && isDraggable && (
            <div {...attributes} {...listeners} className="cursor-move text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300">
              <ProfessionalIcon name="grip" size={16} />
            </div>
          )}
        ...
        <div className="flex items-center gap-2">
          {isEditing ? (
            <>
              <IconButton
                onClick={onSave}
                icon={<ProfessionalIcon name="check" size={16} />}
                variant="ghost"
                size="sm"
              ...
              <IconButton
                onClick={onCancel}
                icon={<ProfessionalIcon name="close" size={16} />}
                variant="ghost"
                size="sm"
                className="text-gray-500 hover:text-gray-700"
              />
...
export default function CategoriesSettings() {
  ...
  const handleDragEnd = (event: DragEndEvent) => {
    ...
    if (activeCategory.level === 'detail' && overCategory.level === 'detail' && activeCategory.parentId !== overCategory.parentId) {
      ...
      updateCategory(active.id as string, { parentId: targetParentId });
                      ...
                      <div className="flex items-center gap-2">
                        {orderedDetailCategories.length > 0 && (
                          <IconButton
                            ...
                            icon={isExpanded ? <ProfessionalIcon name="chevronDown" size={16} /> : <ProfessionalIcon name="chevronRight" size={16} />}
                            variant="ghost"
                            size="sm"
                            className="text-gray-500 hover:text-gray-700"
                          />
    ...
    <PageWrapper 
      ...
      rightContent={
        <div className="flex gap-2">
          ...
          >
            <ProfessionalIcon name="settingsAlt" size={16} />
          </button>
          {isEditMode && (
            <IconButton
          ...
          <IconButton
            ...
            icon={<ProfessionalIcon name="add" size={16} />}
            variant="ghost"
            size="sm"
            className="text-red-500 hover:text-red-700"
            title="Add Category"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 max-w-md w-full">
            <div className="flex items-center gap-3 mb-4">
              <ProfessionalIcon name="warning" className="text-orange-500" size={24} />
