      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <ProfessionalIcon name="warning" size={24} className="text-yellow-600" />
          </div>
          ...
          >
            <ProfessionalIcon name="eye" size={20} />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <ProfessionalIcon name="desktop" size={24} className="text-gray-400" />
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <ProfessionalIcon name="keyboard" size={24} className="text-gray-400" />
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <ProfessionalIcon name="volume" size={24} className="text-gray-400" />
          </div>
        ...
        <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 shadow-md border-l-4 border-amber-400 dark:border-amber-600">
          <div className="flex items-start gap-3">
            <ProfessionalIcon name="success" size={24} className="text-amber-600 dark:text-amber-400 flex-shrink-0 mt-0.5" />
            <div>
