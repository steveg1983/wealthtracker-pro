...
export default function AuditLogs() {
  ...
  const columns = useMemo<Column<unknown>[]>(() => [
      ...
      accessor: (log) => {
        ...
        return (
          <div className="flex items-center gap-2">
            <ProfessionalIcon name="calendar" size={16} className="text-gray-400" />
            <div>
    ...
    },
    {
      ...
      accessor: (log) => {
        ...
        return (
          <div className="flex items-center gap-2">
            <ProfessionalIcon name="database" size={16} className="text-gray-400" />
            <div>
    ...
    },
    {
      ...
      accessor: (log) => {
        ...
        return (
          <div className="flex items-center gap-2">
            <ProfessionalIcon name="user" size={16} className="text-gray-400" />
  ...
  return (
    <PageWrapper
      ...
      icon={<ProfessionalIcon name="document" size={32} className="text-white" />}
    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <ProfessionalIcon name="search" size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="text"
