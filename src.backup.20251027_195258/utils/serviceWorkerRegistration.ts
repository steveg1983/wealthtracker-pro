...
const logger = lazyLogger.getLogger('ServiceWorkerRegistration');
...
export function register(config?: Config): void {
  if ('serviceWorker' in navigator) {
    ...
    let baseUrl = '/';
    try {
      // Service worker compatibility - Safari might not support import.meta.env
...
export function getSyncStatus<T = unknown>(): Promise<T> {
