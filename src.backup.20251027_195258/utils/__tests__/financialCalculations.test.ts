...
import { createMockTransaction, createMockAccount, createMockBudget, createMockGoal } from '../../test/utils/renderWithProviders';
  ...
  describe('Performance and Edge Cases', () => {
    ...
    it('handles missing or undefined values gracefully', () => {
      const malformedTransactions = [
        createMockTransaction({ amount: undefined }),
        createMockTransaction({ type: undefined }),
        createMockTransaction({ date: undefined }),
      ];
