...
export function VirtualizedTransactionList({
  ...
  const renderTransaction = useCallback((transaction: Transaction, _index: number, isScrolling?: boolean) => {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              {(transaction.date instanceof Date ? transaction.date : new Date(transaction.date)).toLocaleDateString()} • {transaction.category}
            </div>
          </div>
