...
export default function TaxCalculator(): React.JSX.Element {
  ...
  const getAnnualIncome = (): number => {
    const amount = parseCurrencyDecimal(grossIncome).toNumber();
  ...
  const calculateTax = () => {
    ...
    if (region === 'UK') {
      const ukResult = rawResult as UKTaxCalculation;
      ...
      const marginalRate = ukResult.marginalRate;
      ...
      setResults({
        ...
        total: totalTax,
        effectiveRate,
        ...(marginalRate !== undefined ? { marginalRate } : {}),
        annualIncome,
    ...
    const usResult = rawResult as USTaxCalculation;
    ...
    setResults({
      ...
      ...(usResult.marginalRate !== undefined ? { marginalRate: usResult.marginalRate } : {}),
      annualIncome,
      monthlyIncome: annualIncome / 12,
      weeklyIncome: annualIncome / 52,
      takeHomeAnnual: annualIncome - totalTax,
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        ...
        <button
          ...
          disabled={!grossIncome || parseCurrencyDecimal(grossIncome).lessThanOrEqualTo(0) || !payFrequency || (region === 'UK' && overPensionAge === null)}
