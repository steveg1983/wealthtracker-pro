...
export default function SignInForm({ onSuccess: _onSuccess }: SignInFormProps) {
      ...
      <div className="max-w-md w-full space-y-8 p-8">
        ...
        <div className="text-center">
          <div className="mx-auto h-16 w-16 bg-gradient-to-r from-gray-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg">
            <ProfessionalIcon name="shieldCheck" size={40} className="text-white" />
          </div>
        ...
        <div className="flex rounded-xl bg-gray-100 dark:bg-gray-800 p-1">
          ...
          >
            <ProfessionalIcon name="fingerprint" size={16} />
            Passkey
          </button>
          <button
          ...
          >
            <ProfessionalIcon name="mail" size={16} />
            Magic Link
          </button>
          <button
          ...
          >
            <ProfessionalIcon name="key" size={16} />
            Password
          </button>
        </div>
            ...
            <div className="space-y-6">
              <div className="text-center">
                <div className="mx-auto h-20 w-20 bg-gradient-to-r from-green-400 to-blue-500 rounded-full flex items-center justify-center mb-4">
                  <ProfessionalIcon name="fingerprint" size={48} className="text-white" />
                </div>
            ...
            <div className="space-y-6">
              <div className="text-center">
                <div className="mx-auto h-20 w-20 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full flex items-center justify-center mb-4">
                  <ProfessionalIcon name="mail" size={48} className="text-white" />
                </div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
        ...
        <div className="flex items-center justify-center gap-2 text-xs text-gray-500 dark:text-gray-400">
          <ProfessionalIcon name="shieldCheck" size={16} />
