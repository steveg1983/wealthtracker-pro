...
import { CheckIcon, SunIcon, MoonIcon, ClockIcon, MonitorIcon } from '../icons';
...
export function ThemeCustomizer({ onClose }: ThemeCustomizerProps): React.JSX.Element {
  const { theme, setTheme, setThemeByMode, customThemes } = useTheme();
  ...
  const modeOptions: Array<{ id: 'light' | 'dark' | 'auto' | 'scheduled'; name: string; icon: typeof SunIcon; description: string }> = [
    ...
    { id: 'auto', name: 'Auto', icon: MonitorIcon, description: 'Follow system preference' },
