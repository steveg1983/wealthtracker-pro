    ...
    <div className={`max-w-lg mx-auto ${className}`}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            <ProfessionalIcon name="shield" size={16} />
            Secure Payment
          </div>
        </div>
        ...
        <div className="mt-4 p-3 bg-blue-50 dark:bg-gray-900/20 rounded-lg">
          <div className="flex items-start gap-2">
            <ProfessionalIcon name="check" size={16} className="text-gray-600 mt-0.5 flex-shrink-0" />
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {message && (
          ...
          <ProfessionalIcon name="error" size={20} className="text-red-600 dark:text-red-400 flex-shrink-0 mt-0.5" />
            <div>
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-3">
          ...
          >
            {isLoading ? (
              <>
                <ProfessionalIcon name="refresh" size={20} className="animate-spin" />
                Processing...
              </>
            ) : (
              <>
                <ProfessionalIcon name="shield" size={20} />
                Start Free Trial
              </>
            )}
          </button>
        ...
        <div className="text-center text-sm text-gray-600 dark:text-gray-400">
          <div className="flex items-center justify-center gap-4 mb-2">
            <div className="flex items-center gap-1">
              <ProfessionalIcon name="shield" size={14} />
