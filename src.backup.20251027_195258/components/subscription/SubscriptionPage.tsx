...
import type { SubscriptionPlan, UserSubscription } from '@app-types/subscription';
...
export default function SubscriptionPage({
  ...
  const loadCurrentSubscription = useCallback(async (providedToken?: string) => {
    setIsLoading(true);
    setError(null);
    ...
    return (
      <div className="mb-8">
        {(currentView === 'payment' || currentView === 'success') && (
          ...
          >
            <ProfessionalIcon name="chevronLeft" size={16} />
            Back to Plans
          </button>
        )}
        ...
        return (
          <div className="max-w-2xl mx-auto text-center py-12">
            <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <ProfessionalIcon name="success" size={32} className="text-green-600" />
            </div>
