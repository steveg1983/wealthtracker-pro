...
type StripeStatusResponse = StripeSubscriptionStatus | { success?: false; error?: string };
    ...
    <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
      ...
      {error && (
        <div className="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg mb-4">
          <div className="flex items-center gap-2">
            <ProfessionalIcon name="error" size={16} className="text-red-600 dark:text-red-400" />
      ...
      {status && (
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            <ProfessionalIcon name="success" size={16} className="text-green-600 dark:text-green-400" />
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="text-sm">
                    ...
                    <span className="ml-2">
                      {formatCurrency(
                        toDecimal(status.subscription.priceAmount).dividedBy(100),
                        status.subscription.currency.toUpperCase()
                      )}
                      /{status.subscription.currency.toUpperCase()}
                    </span>
                  </div>
