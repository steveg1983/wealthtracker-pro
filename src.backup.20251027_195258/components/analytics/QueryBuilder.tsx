...
export interface QueryCondition {
  ...
  value: QueryValue;
  value2?: QueryValue; // For 'between' operator
}
...
export default function QueryBuilder({ onSave, onCancel, initialQuery }: QueryBuilderProps): React.JSX.Element {
  ...
  const updateAggregation = (index: number, updates: Partial<QueryAggregation>) => {
    ...
    const currentAggregation = newAggregations[index];
    if (currentAggregation) {
      newAggregations[index] = { ...currentAggregation, ...updates };
  ...
  const updateSort = (index: number, updates: Partial<QuerySort>) => {
    ...
    if (currentSort) {
      newSortBy[index] = { ...currentSort, ...updates };
      setSortBy(newSortBy);
    }
  };
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
      ...
      <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
        <div className="flex items-center gap-2 mb-3">
          <ProfessionalIcon name="calendar" size={20} className="text-gray-600 dark:text-gray-400" />
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <ProfessionalIcon name="filter" size={20} className="text-gray-600 dark:text-gray-400" />
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <ProfessionalIcon name="layers" size={20} className="text-gray-600 dark:text-gray-400" />
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <ProfessionalIcon name="arrowUp" size={20} className="text-gray-600 dark:text-gray-400" />
