  ...
  const getInsightIcon = (type: SpendingInsight['type']) => {
    switch (type) {
      case 'subscription_alert':
        return <ProfessionalIcon name="creditCard" size={14} className="text-gray-600 dark:text-gray-500" />;
      case 'spending_spike':
        return <ProfessionalIcon name="trendingUp" size={14} className="text-red-600 dark:text-red-400" />;
      case 'new_merchant':
        return <ProfessionalIcon name="search" size={14} className="text-green-600 dark:text-green-400" />;
      default:
        return <ProfessionalIcon name="notification" size={14} className="text-gray-600 dark:text-gray-400" />;
    }
  };
  ...
  if (isLoading) {
    return (
      <div className="h-full flex items-center justify-center">
        <ProfessionalIcon name="refresh" size={24} className="animate-spin text-gray-400" />
      </div>
    );
  }
    ...
    return (
      <div className="h-full flex items-center justify-center text-gray-500 dark:text-gray-400">
        <div className="text-center">
          <ProfessionalIcon name="database" size={32} className="mx-auto mb-2 opacity-50" />
    ...
    return (
      <div className="h-full flex flex-col">
        <div className="flex items-center gap-2 mb-3">
          <ProfessionalIcon name="database" size={16} className="text-gray-600 dark:text-gray-500" />
        ...
        {insights.length > 0 && (
          <div className="mt-2 pt-2 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-1">
              <ProfessionalIcon name="notification" size={12} className="text-orange-600 dark:text-orange-400" />
      ...
      <div className="h-full flex flex-col">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <ProfessionalIcon name="database" size={20} className="text-gray-600 dark:text-gray-500" />
        ...
        {showSubscriptions && (
          <div className="mb-4">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-400">
              {formatPercentageValue(stats.categoryAccuracy, 1)} categorization accuracy
            </div>
          </div>
        )}
        ...
        {showInsights && insights.length > 0 && (
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <ProfessionalIcon name="notification" size={14} className="text-orange-600 dark:text-orange-400" />
        ...
        <div className="mt-auto pt-3 border-t border-gray-200 dark:border-gray-700">
          <button className="w-full flex items-center justify-center gap-2 text-sm text-gray-600 dark:text-gray-500 hover:text-blue-700 dark:hover:text-gray-300">
            ...
            <ProfessionalIcon name="arrowRight" size={12} />
          </button>
        </div>
      </div>
    );
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <ProfessionalIcon name="database" size={18} className="text-gray-600 dark:text-gray-500" />
        ...
        <button
          ...
          className="p-1 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
        >
          <ProfessionalIcon name="refresh" size={12} />
        </button>
      </div>
      ...
      {showSubscriptions && (
        <div className="mb-3 p-2 bg-gray-50 dark:bg-gray-800 rounded">
          <div className="text-sm font-medium text-gray-900 dark:text-white">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-400">
              {formatPercentageValue(stats.categoryAccuracy, 1)} accuracy
            </div>
        </div>
      )}
      ...
      <div className="mt-auto pt-2 border-t border-gray-200 dark:border-gray-700">
        <button className="w-full flex items-center justify-center gap-2 text-xs text-gray-600 dark:text-gray-500 hover:text-blue-700 dark:hover:text-gray-300">
          ...
          <ProfessionalIcon name="arrowRight" size={10} />
        </button>
      </div>
    </div>
  );
