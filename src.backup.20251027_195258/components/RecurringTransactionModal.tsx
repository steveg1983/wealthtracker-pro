    ...
    },
    {
      onSubmit: (data) => {
        ...
        const payload = {
          ...
          amount: toStorageNumber(parseCurrencyDecimal(String(data.amount))),
          type: data.type,
        ...
        } satisfies Omit<RecurringTransaction, 'id' | 'createdAt' | 'updatedAt' | 'nextDate'> & { nextDate?: Date };
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        {formatCurrency(Math.abs(recurring.amount))} · {recurring.frequency}
                      </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateField('amount', toStorageNumber(parseCurrencyDecimal(e.target.value || '0')))}
                  className="w-full px-3 py-2 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-gray-300/50 dark:border-gray-600/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent dark:text-white"
                />
              </div>
            </div>
