...
import { getCurrencySymbol, parseCurrencyDecimal } from '../utils/currency-decimal';
    ...
    },
    {
      onSubmit: (data) => {
        try {
          ...
          const baseAmountDecimal = amountDecimal.abs();
          const finalAmountDecimal = data.type === 'expense' ? baseAmountDecimal.negated() : baseAmountDecimal;
          const finalAmount = toStorageNumber(finalAmountDecimal);
          ...
          if (validatedData.notes) {
            transactionPayload.notes = validatedData.notes;
          }
