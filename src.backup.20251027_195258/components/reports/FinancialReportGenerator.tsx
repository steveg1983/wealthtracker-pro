      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          >
            {isGenerating ? (
              <>
                <ProfessionalIcon name="clock" size={20} className="animate-spin" />
                Generating...
              </>
            ) : (
              <>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <button
              ...
              `}
            >
              <ProfessionalIcon name="document" size={24} className="mx-auto mb-1 text-red-600" />
            ...
            <button
              ...
              `}
            >
              <ProfessionalIcon name="grid" size={24} className="mx-auto mb-1 text-green-600" />
            ...
            <button
              ...
              `}
            >
              <ProfessionalIcon name="download" size={24} className="mx-auto mb-1 text-gray-600" />
            ...
            {reportOptions.sections.map(section => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  >
                    {section.enabled ? (
                      <ProfessionalIcon name="success" size={20} className="text-green-600" />
                    ) : (
                      <ProfessionalIcon name="close2" size={20} className="text-gray-400" />
                    )}
                  </button>
                  <div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div className="text-xl font-bold text-gray-600">
              {formatPercentageValue(reportData.savingsRate, 1)}
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 p-4 bg-blue-50 dark:bg-gray-900/20 rounded-lg">
          <div className="flex items-start gap-2">
            <ProfessionalIcon name="presentation" size={20} className="text-gray-600 mt-0.5" />
            <div>
