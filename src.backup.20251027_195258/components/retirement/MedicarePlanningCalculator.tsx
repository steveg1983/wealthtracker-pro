...
type FilingStatus = 'single' | 'married_joint' | 'married_separate';
type SupplementalType = 'none' | 'medigap' | 'advantage';
...
const calculatePartBPremium = (income: number, filingStatus: FilingStatus): number => {
  const brackets = PART_B_2024.irmaa_brackets[filingStatus];
...
const calculatePartDAdjustment = (income: number, filingStatus: FilingStatus): number => {
  const brackets = PART_D_2024.irmaa_brackets[filingStatus];
  const bracket = brackets.find(b => income >= b.min && income < b.max);
      ...
      <div className="space-y-6">
        ...
        <div className="border-b pb-6">
          <div className="flex items-center gap-2 mb-4">
            <ProfessionalIcon name="heart" className="h-5 w-5 text-red-500" size={20} />
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 p-3 rounded-lg">
              <div className="flex items-start gap-2">
                <ProfessionalIcon name="info" className="h-4 w-4 text-gray-600 mt-0.5" size={16} />
        ...
        <div className="border-b pb-6">
          <div className="flex items-center gap-2 mb-4">
            <ProfessionalIcon name="shield" className="h-5 w-5 text-gray-500" size={20} />
              ...
              <>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      const nextStatus = e.target.value as FilingStatus;
                      setPlan(prev => ({
                        ...prev,
                        partB: { ...prev.partB, filingStatus: nextStatus }
                      }));
                    }}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
                  >
        ...
        <div className="border-b pb-6">
          <div className="flex items-center gap-2 mb-4">
            <ProfessionalIcon name="pill" className="h-5 w-5 text-green-500" size={20} />
            ...
            {plan.partD.enrolled && (
              <>
                ...
                <div className="bg-green-50 p-3 rounded-lg">
                  <div className="flex items-start gap-2">
                    <ProfessionalIcon name="info" className="h-4 w-4 text-green-600 mt-0.5" size={16} />
        ...
        <div className="border-b pb-6">
          <div className="flex items-center gap-2 mb-4">
            <ProfessionalIcon name="eye" className="h-5 w-5 text-purple-500" size={20} />
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  const nextType = e.target.value as SupplementalType;
                  setPlan(prev => ({
                    ...prev,
                    supplemental: { ...prev.supplemental, type: nextType }
                  }));
                }}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
              >
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
          <div className="flex items-center gap-2 mb-4">
            <ProfessionalIcon name="dollar" className="h-6 w-6 text-gray-600" size={24} />
