...
import type { UKStatePensionCalculation } from '../../services/ukRetirementService';
...
export default function StatePensionCalculator(): React.JSX.Element {
  ...
  const [calculation, setCalculation] = useState<UKStatePensionCalculation | null>(null);
  ...
  }, [birthYear, deferYears, qualifyingYears]);
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="mt-2 flex items-start gap-2">
            <ProfessionalIcon name="info" size={14} className="text-blue-500 mt-0.5" />
        ...
        <div className="mt-6 pt-6 border-t">
          ...
          {qualifyingYears < 10 ? (
            <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg flex items-start gap-2">
              <ProfessionalIcon name="error" size={18} className="text-red-600 dark:text-red-400 mt-0.5" />
              <div>
            ...
            <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg flex items-start gap-2">
              <ProfessionalIcon name="success" size={18} className="text-green-600 dark:text-green-400 mt-0.5" />
              <div>
            ...
            <div className="mb-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg flex items-start gap-2">
              <ProfessionalIcon name="info" size={18} className="text-yellow-600 dark:text-yellow-400 mt-0.5" />
              <div>
