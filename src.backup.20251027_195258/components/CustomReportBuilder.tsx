...
export default function CustomReportBuilder({
  ...
  const { accounts: _accounts, categories: _categories, tags: _tags } = useApp();
  ...
  const [, setEditingComponent] = useState<string | null>(null);
  ...
  const moveComponent = (fromIndex: number, direction: 'up' | 'down') => {
    ...
    const removedItems = items.splice(fromIndex, 1);
      ...
      <div className="p-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex flex-wrap gap-3">
          <select
            ...
            onChange={(e) => {
              const nextRange = e.target.value as CustomReport['filters']['dateRange'];
              setFilters({ ...filters, dateRange: nextRange });
            }}
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center gap-2">
                  <select
                    ...
                    onChange={(e) => {
                      const nextWidth = e.target.value as ReportComponent['width'];
