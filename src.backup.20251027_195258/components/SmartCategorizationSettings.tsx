          ...
          <div className="mt-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-green-800 dark:text-green-200">
                ...
                with an average confidence of <strong>{formatPercentageValue(toDecimal(autoCategorizeResult.confidence).times(100), 0)}</strong>
              </p>
            </div>
          </div>
        )}
                  ...
                  {preview.map(item => {
                    ...
                    return (
                      <tr key={item.id}>
                        ...
                        <td className="px-3 py-2">{item.suggestion ? formatPercentageValue(toDecimal(item.suggestion.confidence).times(100), 0) : '—'}</td>
