...
const WIDGET_ICON_NAMES: Record<WidgetConfig['type'], ProfessionalIconName> = {
  'net-worth': 'trendingUp',
  'cash-flow': 'chartBar',
  'budget-summary': 'piggyBank',
  'goal-progress': 'goals',
  'recent-transactions': 'transactions',
  'expense-breakdown': 'chartDonut',
  'investment-summary': 'investments',
  'upcoming-bills': 'calendar',
  'weekly-summary': 'chartLine',
  'monthly-summary': 'calendar',
  'bank-connections': 'creditCard',
  'ai-analytics': 'magicWand',
  'tax-planning': 'calculator',
  'investment-enhancement': 'trendingUp',
  'security': 'shield',
  'collaboration': 'users',
  'mobile-app': 'phone',
  'business': 'briefcase',
  'financial-planning': 'analyticsReport',
...
export default function DashboardWidget({ 
  ...
  const iconName = WIDGET_ICON_NAMES[config.type] ?? 'chartBar';
  ...
  const handleRefreshIntervalChange = (value: number): void => {
    setTempConfig(prevConfig => {
      ...
      if (value > 0) {
        nextConfig.refreshInterval = value;
      } else {
        delete nextConfig.refreshInterval;
      }
      return nextConfig;
    });
  };
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 p-6 h-full flex flex-col">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <ProfessionalIcon name={iconName} className="text-[var(--color-primary)]" size={20} />
          ...
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            >
              <ProfessionalIcon name="refresh" size={16} className={isRefreshing ? 'animate-spin' : ''} />
            </button>
            ...
            <div className="flex">
              ...
              >
                <ProfessionalIcon name="minimize" size={16} />
              </button>
              <button
              ...
              >
                <ProfessionalIcon name="grid" size={16} />
              </button>
              <button
              ...
              >
                <ProfessionalIcon name="maximize" size={16} />
              </button>
            </div>
