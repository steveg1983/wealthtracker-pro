          ...
          {isEditMode && (
            <div className="flex items-center gap-1">
              {onToggleSize && (
                ...
                >
                  {isCompact ? (
                    <ProfessionalIcon name="maximize" size={16} className="text-gray-500" />
                  ) : (
                    <ProfessionalIcon name="minimize" size={16} className="text-gray-500" />
                  )}
                </button>
              )}
              ...
              {onSettings && (
                ...
                >
                  <ProfessionalIcon name="settings" size={16} className="text-gray-500" />
                </button>
              )}
              ...
              {onRemove && (
                <button
                  ...
                  title="Remove widget"
                >
                  <ProfessionalIcon name="close" size={16} className="text-red-500" />
                </button>
              )}
            </div>
          )}
