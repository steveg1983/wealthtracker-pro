...
export default function BudgetAlertSettings() {
  ...
  const exampleBudget = new Decimal(500);
  const warningThresholdAmount = exampleBudget
    .times(alertThreshold ?? 0)
    .dividedBy(100)
      ...
      <div className="space-y-6">
        ...
        <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            you'll receive a warning when you've spent £{warningThresholdAmount}.
          </p>
        </div>
      </div>
    </div>
