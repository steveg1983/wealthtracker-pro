...
describe('PreferencesContextSafe', () => {
  ...
  describe('PreferencesProvider', () => {
    ...
    it('logs initialization messages', () => {
      ...
      expect(loggerSpy).toHaveBeenCalledWith('PreferencesProvider initializing...');
      expect(loggerSpy).toHaveBeenCalledWith('PreferencesProvider state initialized');
      expect(loggerSpy).toHaveBeenCalledWith('PreferencesProvider rendering', expect.any(Object));
