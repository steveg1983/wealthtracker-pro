...
import { SearchIcon, FilterIcon, XIcon, ClockIcon, TagIcon, CalendarIcon, DollarSignIcon, StarIcon } from './icons';
                  ...
                  <label key={type} className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        onOptionsChange({ types: nextTypes } as Partial<SearchOptions>);
                      }}
